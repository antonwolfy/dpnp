...
* Added a `"same_value"` casting mode to `dpnp.astype`, `dpnp.ndarray.astype`, and `dpnp.tensor.astype`, which raises a `ValueError` if a numeric cast would change any value [#3052](https://github.com/IntelPython/dpnp/pull/3052)
